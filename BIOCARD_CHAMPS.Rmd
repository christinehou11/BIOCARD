...
# save processed data
write.csv(data_champs_clean, "processed-data/CHAMPS_clean_data.csv")
```
...
summary_stats <- data.frame(
  ...
  Mean_ALL_INT = sprintf("%.2f (%.2f)", mean(data_champs_clean$HIGH_INT_FREQ, na.rm = TRUE), sd(data_champs_clean$HIGH_INT_FREQ, na.rm = TRUE)),
