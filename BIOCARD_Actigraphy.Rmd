...
# save processed data
write.csv(data_act_clean, "processed-data/Actigraphy_clean_data.csv")
```
...
summary_stats <- data.frame(
  ...
  Mean_Time = sprintf("%.2f (%.2f)", mean(data_act_clean$AgeAtVisit - data_act_clean$Age_Act, na.rm = TRUE), sd(data_act_clean$AgeAtVisit - data_act_clean$Age_Act, na.rm = TRUE)),
  
  # Mean Range (min, max) time (in years) 
  Range_Time = sprintf("(%.2f, %.2f)", min(data_act_clean$AgeAtVisit - data_act_clean$Age_Act, na.rm = TRUE), max(data_act_clean$AgeAtVisit - data_act_clean$Age_Act, na.rm = TRUE)),
